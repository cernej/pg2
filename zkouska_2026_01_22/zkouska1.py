...
def test_filtruj_cisla():
    assert filtruj_cisla("kladna", [1, -2, 0, 5, -3]) == [1, 5]
    assert filtruj_cisla("suda", [1, 2, 3, 4, 5]) == [2, 4]
    assert filtruj_cisla("zaporna", [1, -2, 0, 5, -3]) == [-2, -3]
    assert filtruj_cisla("licha", [1, 2, 3, 4, 5]) == [1, 3, 5]
    assert filtruj_cisla("xxx", [1, 2, 3]) == []
    assert filtruj_cisla("kladna", []) == []
    assert filtruj_cisla("suda", []) == []
    assert filtruj_cisla("zaporna", []) == []
    assert filtruj_cisla("licha", []) == []
